...
bot = telepot.Bot('6394300738:AAE5EOBdZUeFg4rVEv2-csBcdSY3nYntGk8')
...
def handle_start(chat_id):
    instructions = "🌟 Welcome to the Expense Tracker Bot! \nSimply track your expenses or earnings using 'Description Amount'. \nE.g., 'Uber tax -29.39' or 'Earned work 2000'. \nLet's make budgeting a breeze! 💸✨"
